...
class MenuView extends \yii\base\Widget
{
    ...
    public $liTemplate = "<li id='menu-item-{menu_id}' class='menu-item menu-item-type-taxonomy menu-item-object-category {current_menu_class} menu-item-{menu_id}'><a href='{url}' target='{target}' style='color:white;padding: 13px;'>{title}</a>{sub_menu}</li>";
